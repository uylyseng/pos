        ...
        <div class="flex flex-col lg:flex-row justify-between items-center gap-4 mb-6">
            ...
            <div class="w-full lg:w-auto flex flex-col sm:flex-row gap-3">
                ...
                <div class="flex space-x-1 bg-white rounded-lg shadow p-1">
                    <a href="{{ route('orders.index', ['status' => 'all', 'search' => request('search')]) }}"
                    ...
                    <a href="{{ route('orders.index', ['status' => 'completed', 'search' => request('search')]) }}"
                    ...
                    <a href="{{ route('orders.index', ['status' => 'failed', 'search' => request('search')]) }}"
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 border-b border-gray-200 hidden md:grid">
                <div class="bg-blue-50 rounded-lg p-4">
                    ...
                    <p class="text-2xl font-bold text-blue-700">{{ $ordersCount['total'] ?? $orders->total() }}</p>
                </div>
